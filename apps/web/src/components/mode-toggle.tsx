	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger render={<Button size="icon" variant="ghost" />}>
				<Sun className="size-4 rotate-0 scale-100 text-muted-foreground transition-all dark:-rotate-90 dark:scale-0" />
				<Moon className="absolute size-4 rotate-90 scale-0 text-muted-foreground transition-all dark:rotate-0 dark:scale-100" />
